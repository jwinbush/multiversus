var OneTrustStub = (function (e) {
  ...
  var ae = "geo",
    ...
    se = "PRODUCTION",
    le =
      (((ne = {})[M.Days] = "PCenterVendorListLifespanDay"),
      (ne[M.Weeks] = "LfSpnWk"),
  ...
  var ue =
    ((de.prototype.initConsentSDK = function () {
    ...
    (de.prototype.captureNonce = function () {
      this.nonce =
        ie.stubScriptElement.nonce ||
        ie.stubScriptElement.getAttribute("nonce") ||
        null;
    }),
    (de.prototype.fetchBannerSDKDependency = function () {
      this.setDomainDataFileURL(),
        (this.crossOrigin =
          ie.stubScriptElement.getAttribute("crossorigin") || null),
    ...
    (de.prototype.getLocation = function (e) {
      ...
      if (r.OneTrust && r.OneTrust.geolocationResponse) {
        ...
        var l = this.readCookieParam(
          ie.optanonCookieName,
          ie.geolocationCookiesParam
        );
    ...
    (de.prototype.getGeolocationURL = function (e) {
      ...
      var t =
        "" +
        ie.stubScriptElement.getAttribute("src").split(ie.stubFileName)[0] +
        e.Version;
    ...
    (de.prototype.setOTDataLayer = function () {
      ...
      this.otDataLayer = {
        ignore: n,
        name:
          ie.stubScriptElement.getAttribute("data-dLayer-name") || "dataLayer",
      };
    }),
    (de.prototype.setGeoLocation = function (e, t) {
      void 0 === t && (t = ""), (ie.userLocation = { country: e, state: t });
    }),
    ...
    (de.prototype.validateIABGlobalScope = function () {
      var e = this.readCookieParam(
        ie.optanonCookieName,
        ie.oneTrustIsIABCrossConsentEnableParam
      );
      e
        ? "true" === e
          ? ((ie.hasIABGlobalScope = !0), (ie.isStubReady = !1))
          : ((ie.hasIABGlobalScope = !1),
            (ie.IABCookieValue = this.getCookie(ie.oneTrustIABCookieName)))
        : (ie.isStubReady = !1);
    }),
    (de.prototype.validateIABGDPRApplied = function () {
      ...
      e
        ? this.isBoolean(e)
          ? (ie.oneTrustIABgdprAppliesGlobally = "true" === e)
          : (ie.oneTrustIABgdprAppliesGlobally = 0 <= ie.EUCOUNTRIES.indexOf(e))
        : (ie.isStubReady = !1);
    }),
    ...
    (de.prototype.updateGtmMacros = function () {
      var e,
        t = [],
        o = ie.optanonHtmlGroupData.length;
      for (e = 0; e < o; e++)
        this.endsWith(ie.optanonHtmlGroupData[e], ":1") &&
          t.push(ie.optanonHtmlGroupData[e].replace(":1", ""));
      for (o = ie.optanonHostData.length, e = 0; e < o; e++)
        this.endsWith(ie.optanonHostData[e], ":1") &&
          t.push(ie.optanonHostData[e].replace(":1", ""));
      for (o = ie.genVendorsData.length, e = 0; e < o; e++)
        this.endsWith(ie.genVendorsData[e], ":1") &&
          t.push(ie.genVendorsData[e].replace(":1", ""));
      for (o = ie.vendorsServiceData.length, e = 0; e < o; e++)
        this.endsWith(ie.vendorsServiceData[e], ":1") &&
          t.push(ie.vendorsServiceData[e].replace(":1", ""));
    ...
    (de.prototype.setStubScriptElement = function () {
      ie.stubScriptElement = document.querySelector(
        "script[src*='" + ie.stubFileName + "']"
      );
      var e =
        ie.stubScriptElement &&
        0 <= ie.stubScriptElement.getAttribute("src").indexOf("did=");
      ie.stubScriptElement &&
      ie.stubScriptElement.hasAttribute(ie.DATAFILEATTRIBUTE)
        ? (this.domainId = ie.stubScriptElement
            .getAttribute(ie.DATAFILEATTRIBUTE)
            .trim())
        : e
        ? (this.domainId = ie.stubScriptElement
            .getAttribute("src")
    ...
    (de.prototype.setDomainDataFileURL = function () {
      ...
      e &&
        (ie.isMigratedURL
          ? (ie.storageBaseURL = e.split("/consent/" + ie.migratedCCTID)[0])
          : (ie.storageBaseURL = t
              ? e.split("/consent")[0]
              : e.split("/scripttemplates/" + ie.stubFileName)[0])),
        (this.storageBaseURL = ie.storageBaseURL),
        this.isPreview && -1 === this.domainId.indexOf("test")
          ? (this.domainId = this.domainId + "-test")
          : (this.isPreview = !1),
        (ie.bannerBaseDataURL =
          ie.storageBaseURL && ie.storageBaseURL + "/consent/" + this.domainId),
        (ie.bannerDataParentURL =
          ie.bannerBaseDataURL + "/" + this.domainId + ".json");
    }),
    ...
    (this.iabType = null),
      ...
      (this.addBannerSDKScript = function (e) {
        ...
        [
          ...
          ie.stubScriptElement.getAttribute(e) &&
            o.setAttribute(e, ie.stubScriptElement.getAttribute(e));
        }),
